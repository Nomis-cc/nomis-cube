...
namespace Nomis.Cubescan.Interfaces.Models
{
        ...
        : IWalletStats
    {
        ...
        /// <inheritdoc/>
        [Description("Wallet balance (CUBE)")]
        ...
        /// <inheritdoc/>
        [Description("The movement of funds on the wallet (CUBE)")]
        ...
        /// <inheritdoc/>
        [Description("NFT trading activity (CUBE)")]
        public decimal NftTrading { get; set; }

        /// <inheritdoc/>
        [Description("NFT worth on wallet (CUBE)")]
